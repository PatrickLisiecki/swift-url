...
export default function Login() {
	...
	return (
		<main className="relative h-screen w-full bg-dark-body">
			<section className="flex w-full flex-col items-center justify-center py-[200px]">
				<h1 className="mb-[50px] text-3xl tracking-wide text-dark-text">Sign in to your account</h1>
				<form
				...
				>
					...
					<button
						type="submit"
						className="w-full rounded border border-dark-border bg-dark-bg px-4 py-3 text-[14px] font-semibold uppercase text-dark-text hover:border-dark-border-hover hover:bg-[#393939]"
					>
						Sign in
					</button>
				</form>
